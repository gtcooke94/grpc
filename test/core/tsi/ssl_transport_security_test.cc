...
TEST(SslTransportSecurityTest, MapSslErrorToTlsTelemetryStatusTest) {
  ...
  EXPECT_EQ(tsi::MapSslErrorToTlsTelemetryStatus(SSL_ERROR_NONE, 0,
  ...
  EXPECT_EQ(tsi::MapSslErrorToTlsTelemetryStatus(
  ...
  EXPECT_EQ(
      tsi::MapSslErrorToTlsTelemetryStatus(SSL_ERROR_ZERO_RETURN, 0, X509_V_OK),
      tsi::TlsTelemetryStatus::PEER_CONNECTION_CLOSED);
  EXPECT_EQ(
      tsi::MapSslErrorToTlsTelemetryStatus(SSL_ERROR_SYSCALL, 0, X509_V_OK),
      tsi::TlsTelemetryStatus::PEER_CONNECTION_CLOSED);
  ...
  EXPECT_EQ(
      tsi::MapSslErrorToTlsTelemetryStatus(
