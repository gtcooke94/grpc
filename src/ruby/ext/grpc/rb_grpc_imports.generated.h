...
typedef when all wrapped langauges support C++ in // core APIs /** * EXPERIMENTAL API - Subject to change * * Sets the crl provider in the options. */ void(*grpc_tls_credentials_options_set_crl_provider_type)(grpc_tls_credentials_options* options, std::shared_ptr<grpc_core::experimental::CrlProvider> provider);
