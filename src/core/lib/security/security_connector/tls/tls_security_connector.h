...
class TlsChannelSecurityConnector final
 ...
 private:
  ...
  // TlsCertificateDistributorImpl. It will never outlive
  // |security_connector_|.
  class TlsChannelCertificateWatcher
      : public TlsCertificateDistributorImpl::TlsCertificatesWatcherInterface {
   public:
  ...
  TlsCertificateDistributorImpl::TlsCertificatesWatcherInterface*
